...
# Specify the file name and path to save the image
image_path = "C:/Projects/579-Intelligent-Systems-Term-Project/06_Source/Python/Dependencies/captured_image.jpg"
